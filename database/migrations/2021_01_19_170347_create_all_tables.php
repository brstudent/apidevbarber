...
class CreateAllTables extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('babers');
        Schema::dropIfExists('baberphotos');
        Schema::dropIfExists('baberreviews');
        Schema::dropIfExists('baberservices');
        Schema::dropIfExists('babertestimonials');
